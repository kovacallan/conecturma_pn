<table class="table table-bordered" style="margin-top:0;">
    ...
    <tr class="hoover ex" style="cursor: pointer;"
        onclick="grafico_escola('grafico{{i['id']}}', {{turma}}, {{notas[teste]}});esconder('grafico{{i['id']}}')">
        ...
        <td class="hiddenRow" colspan="3">
            <div id="grafico{{i['id']}}" class="accordian-body collapse grafico{{i['id']}}">
                <div class="col-md-12" style="margin-top: 15px;">
                    ...
                    <select id="ordenarGraficoRelatorio_grafico{{i['id']}}"
                            onchange="ordenarGraficoRelatorio('grafico{{i['id']}}', {{turma}}, {{notas[teste]}})">
