                                    ...
                                    <div class="row distanciamento">
                                        ...
                                        <div class="col-md-" style="padding-left: 10px ;">
                                            ...
                                            <input type="text" size="33" class="form-control disabled{{i['id']}}"
                                                   name="" id="data_cadastro" value="data_cadastro" disabled>
                                        </div>
                                    </div>
                                    <div class="row distanciamento">
                                        <div class="col-md-">
                                            ...
                                            <input type="hidden" size="59" class="form-control disabled{{i['id']}}"
                                                   name="" id="rede{{i['id']}}" value="{{i['vinculo_rede_id']}}">
                                            <input type="text" size="59" class="form-control disabled{{i['id']}}"
                                                   name="" id="rede{{i['id']}}" value="{{i['vinculo_rede']}}" disabled>
                                        </div>
                                    </div>
