<div class="modal fade" id="cadastroaluno{{i['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                                            ...
                                            <div class="col-md-12" style="margin-top:10px;">
                                                <div class="row">
                                                    <div class="col-md-4 offset-md-1">
                                                        ...
                                                        <span style="color:#ff0000">*</span>
                                                        <br>
                                                        <input type="text" size="30" class="form-control" required
                                                               name="" id="aluno_nascimento_{{i['id']}}"
