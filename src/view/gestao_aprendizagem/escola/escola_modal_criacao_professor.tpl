<div class="modal fade" id="cadastroProf{{i['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                                    ...
                                    <div class="tab-pane fade show active container active" role="tabpanel"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 offset-md-1">
                                                        ...
                                                        <input type="date" size="25" class="form-control" required
                                                               name="" id="professor_nascimento_{{i['id']}}"
                                                               onchange="document.getElementById('professor_nascimento').style.boxShadow = 'none'">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="email" size="25" class="form-control"
                                                               ...
                                                               id="professor_email_{{i['id']}}"
                                                               onchange="emailValidador('professor_email_{{i['id']}}')">
                                                    </div>
                                                </div>
                                            </div>
                                            .
                                            <div class="col-md-10 offset-md-1" style="margin-top: 10px;">
                                                ...
                                                <select id="professor_turma_{{i['id']}}"
