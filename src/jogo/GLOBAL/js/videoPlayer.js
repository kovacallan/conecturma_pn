...
if(_online) {
  ...
  var _url = URL_VIDEO;
  console.log("video_off " +URL_VIDEO);
  document.getElementById("video_off").src = _url;

  var aud = document.getElementById("video_off");
  aud.onended = function() {
    //alert("The audio has ended");
    if(isFinalCinematic) {
      window.parent.location.href = URL_MAPA;
      console.log('window.parent.location.href' +URL_MAPA);
    } else {
      console.log('window.parent' +URL_MAPA);
      window.parent.game.state.states["Game"].hideVideo();
