...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.caminho = getPathFile(UV1AV1UD2MAPA);		
		this.load.image('background', this.caminho+'background.png');

		// CHARACTER ANIMATION
		this.load.atlas('backgroundAnimation', this.caminho+'background_animation.png', this.caminho+'background_animation.json')
