...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.atlas('curupira', this.caminho+'curupira.png', this.caminho+'curupira.json');
		this.load.atlas('fada1', this.caminho+'fada1.png', this.caminho+'fada1.json');
		this.load.atlas('fada2', this.caminho+'fada2.png', this.caminho+'fada2.json');
		this.load.atlas('fada3', this.caminho+'fada3.png', this.caminho+'fada3.json');
		this.load.atlas('saci', this.caminho+'saci.png', this.caminho+'saci.json');
