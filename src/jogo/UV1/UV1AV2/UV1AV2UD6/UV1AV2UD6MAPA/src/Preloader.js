...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		// SCENE
		this.caminho = getPathFile(UV1AV2UD6MAPA);

		this.load.image('background', this.caminho+'background.png');
		this.load.image('backgroundFrente', this.caminho+'background_frente.png');

		// CHARACTER ANIMATION
		this.load.atlas('iara', this.caminho+'iara.png', this.caminho+'iara.json');
		this.load.atlas('junior', this.caminho+'junior.png', this.caminho+'junior.json');
		this.load.atlas('flor1', this.caminho+'flor1.png', this.caminho+'flor1.json');
		this.load.atlas('flor2', this.caminho+'flor2.png', this.caminho+'flor2.json');
