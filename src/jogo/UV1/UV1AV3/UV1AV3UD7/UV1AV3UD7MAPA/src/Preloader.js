...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.caminho = getPathFile(UV1AV3UD7MAPA);

		this.load.image('background', this.caminho+'background.png');
		this.load.image('1', this.caminho+'1.png');
		this.load.image('india2', this.caminho+'india2.png');

		// CHARACTER ANIMATION
		this.load.atlas('poly', this.caminho+'poly.png', this.caminho+'poly.json');
		this.load.atlas('india1', this.caminho+'india1.png', this.caminho+'india1.json');
		this.load.atlas('indio', this.caminho+'indio.png', this.caminho+'indio.json');
