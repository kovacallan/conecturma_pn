...
facade.create_aluno_facade(nome="aluno", senha="123", matricula='123',data_nascimento=date(1994,10,20),sexo="masculino", vinculo_rede='1', escola='2',cpf_responsavel="19443329563")
