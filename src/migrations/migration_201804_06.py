...
medlaha_facade.create_medalha_facade(nome="Medalha1", tipo='1')
medlaha_facade.create_medalha_facade(nome="Medalha2", tipo='2')
medlaha_facade.create_medalha_facade(nome="Medalha3", tipo='1')
medlaha_facade.create_medalha_facade(nome="Medalha4", tipo='1')
medlaha_facade.create_medalha_facade(nome="Medalha5", tipo='2')
